...
<template>
    ...
    <main>
        <div v-if="currentEmployee" class="flex flex-col items-center justify-center gap-6">
            ...
            <h1 class="text-2xl p-5">{{ currentEmployee.userName }}@southtexasccollege.edu</h1>
            <h1 class="text-2xl p-5">{{ currentEmployee.quote }}</h1>
            
            <img class="p-8" :src="faker.image.urlLoremFlickr({width: 640, height: 480, category: 'dog'})"/>
    </div>
